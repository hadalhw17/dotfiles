...
ubnt.sshCommander = function(id, host, username, password, port, cmd, finish, progress) {
    this.id = id;
...
ubnt.sshCommander.doSshCmd = function(id, host, username, password, port, cmd, finish, progress) {
    return new ubnt.sshCommander(id, host, username, password, port, cmd, finish, progress);
};
